...
Game.BG_IMAGE = '/BubbleBros/lib/images/Buster Bros Backgrounds.png';
Game.BG_BORDER = 0.02;
Game.DIM_X = 920;
Game.DIM_Y = 500;
...
Game.HUD_LIVES_IMAGE = '/BubbleBros/lib/images/sprite_file.png';
Game.HUD_LIVES = [153, 81, 16, 16]

Game.STAGE_CLEAR_IMAGE = '/BubbleBros/lib/images/stage_clear.png';
Game.STAGE_CLEAR = [5, 8, 449, 56];

Game.GAME_OVER_IMAGE = '/BubbleBros/lib/images/game_over.png';
